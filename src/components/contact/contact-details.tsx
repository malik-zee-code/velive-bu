    ...
    useEffect(() => {
        const fetchSettings = async () => {
            try {
                ...
                setAddress1(getSetting(settings, 'address_1'));
                setAddress2(getSetting(settings, 'address_2'));
                setEmail(getSetting(settings, 'email'));
                setPhone1(getSetting(settings, 'phone_1'));
                setPhone2(getSetting(settings, 'phone_2'));
                setError(null);
            } catch (err) {
